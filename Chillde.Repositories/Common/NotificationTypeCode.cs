...
namespace Chillde.Repositories.Common
{
    public class NotificationTypeCode
    {
        public static readonly Dictionary<NotificationCode, string> NotiCodes = new()
        {
            ...
            { NotificationCode.Artisan_CancelOrderDueToUnprocessedShipment, "ORD_TRC_07" },
            { NotificationCode.Customer_CancelOrderDueToUnprocessedShipment, "ORD_TRC_08" },
            { NotificationCode.Artisan_AcceptDelivery, "ORD_TRC_09" },
