...
public static class InitialSeeding
{
    ...
    private static readonly List<NotificationContent> NotificationContents = new()
    {
        new()
        {
            ...
            Name = "Khách hàng - Chấp nhận đơn hàng",
        ...
        new()
        {
            ...
            Code = "ORD_02",
            Content =
                "💔 Oops! Nghệ nhân chưa thể thực hiện đơn hàng [#orderCode] lần này rồi. Nhưng đừng lo, vẫn còn nhiều nghệ nhân khác đang chờ đón bạn!",
            Name = "Khách hàng - Từ chối đơn hàng",
            Type = NotificationType.Order,
        },
        new()
        {
        ...
        new()
        {
            ...
            Code = "ORD_TRC_01",
            Content =
                "✨ Tèn ten~ Bản thảo đầu tiên của đơn [#orderCode] đã đến tay bạn! Cùng xem thử và gửi chút góp ý cho nghệ nhân liền nào!",
            Name = "Khách hàng - Bản thảo mới",
        ...
        new()
        {
            ...
            Code = "ORD_TRC_02",
            Content =
                "🛠️ Đèn xanh rồi đó nghệ nhân ơi. Khách đã “gật đầu” với bản thảo đơn [#orderCode]. Triển thôi nào!",
            Name = "Nghệ nhân - Chấp nhận bản thảo",
            Type = NotificationType.OrderTracking,
        },
        new()
        {
            ...
            Code = "ORD_TRC_03",
            Content =
                "🌀 Ui… bản thảo lần này của đơn [#orderCode] chưa “đốn tim” khách hàng rồi. Cùng xem góp ý và làm lại một phiên bản mới tuyệt hơn nhé!",
            Name = "Nghệ nhân - Từ chối bản thảo",
            Type = NotificationType.OrderTracking,
        },
        new()
        {
            ...
            Code = "ORD_TRC_04",
            Content =
                "🎆 Ta-da~ Sản phẩm của đơn [#orderCode] đã được hoàn thành rồi nè! Cùng chiêm ngưỡng sản phẩm của bạn và gửi chút cảm nhận cho nghệ nhân nha 💖",
            Name = "Khách hàng - Delivery mới",
            Type = NotificationType.OrderTracking,
        },
        new()
        {
            ...
            Code = "ORD_TRC_05",
            Content =
                "🎁 Vèo vèo~ Đơn [#orderCode] đang “phi” tới chỗ bạn nè! Nghệ nhân gửi gắm cả tâm huyết vào đó đó, hóng chưa nào?",
            Name = "Khách hàng - Đang giao hàng",
            Type = NotificationType.OrderTracking,
        },
        new()
        {
        ...
        new()
        {
            ...
            Code = "ORD_TRC_07",
            Content =
                "❌ Đơn hàng [#orderCode] đã bị hủy vì bạn chưa tiến hành lên đơn giao hàng trong vòng 24h kể từ khi hết hạn làm sản phẩm. Số tiền đã được hoàn lại cho khách theo chính sách bảo vệ người dùng.",
        ...
        new()
        {
            ...
            Code = "ORD_TRC_08",
            Content =
                "✅ Đơn hàng [#orderCode] đã bị hủy do nghệ nhân không hoàn tất việc lên đơn giao hàng trong vòng 24h kể từ khi hết hạn làm sản phẩm. Bạn sẽ nhận lại tiền trong thời gian sớm nhất. Hẹn gặp lại bạn ở những đơn tiếp theo.",
        ...
        new()
        {
            ...
            Code = "ORD_TRC_09",
            Content =
                "🥳 Khách đã đồng ý với sản phẩm cuối cùng của đơn [#orderCode]. Đơn hàng sẽ tự động bị huỷ nếu đơn vận chuyển không được tạo sau 24h kể từ khi hết hạn làm sản phẩm. Hãy lưu ý và lên đơn vận chuyển đúng hạn!",
        ...
        new()
        {
            ...
            Code = "REP_01",
            Content =
                "⚠️ Đơn hàng [#orderCode] đã bị khách hàng báo cáo. Vui lòng kiểm tra và xem xét vấn đề để có giải pháp phù hợp.",
            Name = "Nghệ nhân - Report đơn hàng",
        ...
        new()
        {
            ...
            Code = "REP_02",
            Content =
                "❌ Yêu cầu báo cáo đơn hàng [#orderCode] từ phía khách hàng đã được chấp nhận. Đơn hàng sẽ được hoàn và tiền sẽ được trả lại cho khách hàng. Hãy chuẩn bị cho quá trình hoàn trả sản phẩm theo đúng quy định.",
            Name = "Nghệ nhân - Report được chấp nhận",
            Type = NotificationType.Report,
        },
        new()
        {
            Id = Guid.Parse("d65489c5-929c-4bd1-98bc-62cd2367f45e"),
            Code = "REP_04",
            Content =
                "✅ Yêu cầu báo cáo đơn hàng [#orderCode] từ phía khách hàng đã bị từ chối sau quá trình xem xét. Đơn hàng được giữ nguyên trạng thái và không ảnh hưởng đến kết quả làm việc của bạn.",
            Name = "Nghệ nhân - Report bị từ chối.",
            Type = NotificationType.Report,
        },
        new()
        {
            Id = Guid.Parse("98064842-2911-4ab8-87b5-c062929fa6f5"),
            Code = "REP_03",
            Content =
                "❌ Chúng tôi đã xem xét yêu cầu báo cáo đơn hàng [#orderCode], tuy nhiên hệ thống quyết định không chấp nhận report này vì không đủ điều kiện. Nếu bạn vẫn gặp vấn đề, đừng ngần ngại liên hệ lại với chúng tôi để được hỗ trợ thêm.",
            Name = "Khách hàng - Report bị từ chối",
            Type = NotificationType.Report,
        },
        new()
        {
            Id = Guid.Parse("dcc20171-35a2-45c5-8b2d-bafee1b88a0f"),
            Code = "REP_05",
            Content =
                "✅ Yêu cầu báo cáo đơn hàng [#orderCode] của bạn đã được chấp nhận sau quá trình xem xét. Chúng tôi sẽ tiến hành các bước xử lý tiếp theo và hỗ trợ thêm theo chính sách.",
            Name = "Khách hàng - Report được chấp nhận.",
            Type = NotificationType.Report,
        },
        new()
        {
            ...
            Code = "FEEDBACK_01",
            Content =
                "📣 Khách đã chia sẻ cảm nhận về dịch vụ [#serviceName] của bạn. Hãy xem thử xem họ thích gì và cần cải thiện điều gì nhé!",
            Name = "Nghệ nhân - Đánh giá mới",
    ...
    public static async Task Initialize(IServiceProvider serviceProvider)
    {
        ...
        {
            if (!context.Categories.Any(c => c.Id == category.Id) && !string.IsNullOrWhiteSpace(category.AttachmentUrl))
            {
