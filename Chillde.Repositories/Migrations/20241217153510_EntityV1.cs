        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromWardCode = table.Column<int>(type: "integer", nullable: true),
                    ToDistrictId = table.Column<int>(type: "integer", nullable: true),
                    ToWardCode = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShippingAddress_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Skills_SubCategory_SubCategoryId",
                        column: x => x.SubCategoryId,
                        principalTable: "SubCategory",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Skills_SubCategory_SubCategoryId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "text", nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true),
                    IsOffter = table.Column<bool>(type: "boolean", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    AccountId = table.Column<Guid>(type: "uuid", nullable: false),
                    ItemId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestDetail_ItemAttribute_ItemAttributeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceWishlist", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceWishlist_ServiceCollection_ServiceCollectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Question = table.Column<string>(type: "text", nullable: true),
                    IsInformationRequired = table.Column<bool>(type: "boolean", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PackageFeature_Feature_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Feature",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackageFeature_Package_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Package",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderInformation_PackageFeature_PackageFeatureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderTrackingImage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderTrackingImage_OrderTracking_OrderTrackingId",
            ...
            migrationBuilder.CreateTable(
                name: "OrderInformationAttachment",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    AttachmentUrl = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderInformationAttachment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderInformationAttachment_OrderInformation_OrderInformatio~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderInformationAttachment_OrderInformationId",
                table: "OrderInformationAttachment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderTrackingImage_OrderTrackingId",
                table: "OrderTrackingImage",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageFeature_FeatureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceWishlist_ServiceCollectionId",
                table: "ServiceWishlist",
                column: "ServiceCollectionId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceWishlist_ServiceId",
                table: "ServiceWishlist",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_ShippingAddress_AccountId",
